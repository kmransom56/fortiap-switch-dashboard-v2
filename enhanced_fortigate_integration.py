#!/usr/bin/env python3
"""
Enhanced FortiGate API Integration Module
    ...
    def get_discovery_summary(self) -> Dict:
        ...
        return {
            ...
            'discovered_capabilities': {
                ...
                'devices_count': len(self.get_user_devices()),
...
if __name__ == "__main__":
    ...
    print(f"\nTopology: {topology['metadata']['total_devices']} devices")
    print(f"FortiAPs: {topology['metadata']['fortiaps_count']}")
    print(f"Devices: {topology['metadata']['endpoints_count']}")
    print(f"Interfaces: {topology['metadata']['interfaces_count']}")
